...
namespace CS321_W2D1_BlogAPI.Services
{
    public class PostService : IPostService
    {
        ...
        public Post Update(Post updatedPost)
        {
            ...
            // another way to do above lone: var currentPost = this.Get(updatedPOst.Id);
        ...
        public void Remove(Post post)
        {
            ...
            // other way to do it: if (currentPOst != null) { _posts.Remove(currentPost); } else { throw new Exception("Cannot remove nonexistent post"); }
